...
REVIEWER_QA_DATA = {
    ...
    "frameworkReadiness": {
        ...
        "finiteBaseAndTesting": {
            "current": "96%",
            "maxWithoutNewAnalyticProof": "97%",
            "missingToReach100": "Add independent deterministic cross-checks from another implementation.",
        },
        "rawNumberEvidence": {
            "current": "96%",
            "maxWithoutNewAnalyticProof": "97%",
            "missingToReach100": "Keep K12_EVIDENCE_PACKET.md current as new raw packets finish.",
        },
        "adversarialStressTesting": {
            "current": "98%",
            "maxWithoutNewAnalyticProof": "99%",
            "missingToReach100": "Continue expanding hardest-residue and covering-wall packets without calling them exhaustive.",
        },
        "reviewerSafeWording": {
            "current": "97%",
            "maxWithoutNewAnalyticProof": "98%",
        ...
        "overallFrameworkReadiness": {
            "current": "94-96%",
            "maxWithoutNewAnalyticProof": "96-97%",
    ...
    "rawEvidenceSummary": {
        "mirrorDesertBreak": {
            "k825Status": "broken in finite K-window packets",
            "k10Status": "broken in finite K-window packets",
            "missesK12": 0,
            "highestTrueKObserved": "10.535772 at C = 33950429",
            "p95K": "stayed low in most tested bands",
            "maxK": "K=12 had zero misses in the completed K-window packets so far",
        ...
        "k12EvidencePacket": {
            "globalCoprimeSweepRows": 9216000,
            "focusedHardestResidueReplayRows": 200000,
            "top100HardestResidueRows": 1000000,
            "missesK12": 0,
            "hardestRows": [
                {
                    "C": 33950429,
    ...
    "unsafeClaimsToAvoid": [
        "Claiming a universal Goldbach proof.",
        "Claiming Lemma 4 is analytically closed.",
        "Claiming finite validation proves the theorem.",
        "Claiming the universal proof is complete.",
    ],
    "safeClaimsToUse": [
